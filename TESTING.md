...
| --- | --- | --- | --- | --- |
|  | [run.py](https://github.com/allaafaham/friend-finder/blob/main/run.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/allaafaham/friend-finder/main/run.py) | ![screenshot](documentation/validation/py--run.png) | Notes (if applicable) |
...
Alternatively, an improved way to manage bugs is to use the built-in **[Issues](https://www.github.com/allaafaham/friend-finder/issues)** tracker on your GitHub repository. This can be found at the top of your repository, the tab called "Issues".
...
[![GitHub issue custom search](https://img.shields.io/github/issues-search?query=repo%3Aallaafaham%2Ffriend-finder%20label%3Abug&label=bugs)](https://www.github.com/allaafaham/friend-finder/issues?q=is%3Aissue+is%3Aclosed+label%3Abug)

I've used [GitHub Issues](https://www.github.com/allaafaham/friend-finder/issues) to track and manage bugs and issues during the development stages of my project.

All previously closed/fixed bugs can be tracked [here](https://www.github.com/allaafaham/friend-finder/issues?q=is%3Aissue+is%3Aclosed+label%3Abug).
...
[![GitHub issues](https://img.shields.io/github/issues/allaafaham/friend-finder)](https://www.github.com/allaafaham/friend-finder/issues)

Any remaining open issues can be tracked [here](https://www.github.com/allaafaham/friend-finder/issues).
